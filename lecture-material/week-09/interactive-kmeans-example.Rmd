...
```{r,echo=FALSE}
demo_url <- "https://lalejini.com/my_empirical_examples/KMeansClusteringExample/web/kmeans_clustering.html"
```

Below is an interactive k-means clustering demo. [You may also access the demo here](https://lalejini.com/my_empirical_examples/KMeansClusteringExample/web/kmeans_clustering.html).
