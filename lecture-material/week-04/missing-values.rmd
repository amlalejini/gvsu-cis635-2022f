...
This activity is meant to server as a "how to" guide and does not discuss _when_ different methods of handling missing values should be applied. l
...
- Describe a procedure for replacing an object's missing value for a particular feature with the value from its nearest neighbor object?
  - What does it mean for one object to be "near" another object? How could you quantify how close two objects are to one another?
