...
for (num_dimensions in dimension_sizes) {
  ...
  # Run ?pdist to see how the pdist function works
...
$$\frac{(MAX_DIST-MIN_DIST)}{MIN_DIST}$$.
...
- Think about the meaning of $$\frac{(MAX_DIST-MIN_DIST)}{MIN_DIST}$$. What's going on as we increase dimensionality?
