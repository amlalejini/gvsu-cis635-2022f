...
3. Finally, we'll apply [TODO] common denoising techniques to each of our noisy signals.
...
- Generate a small sequence of random values. On paper, apply a rolling average filter to your sequence. You decide the window size.
...
- Generate a small sequence of random values. On paper, apply a median filter to your sequence. You decide the window size.
